...
import { WorkspacesV2 } from "./workspaces2/index.js";
...
import { KeyboardLayout } from "./keyboard_layout/index.js";
...
const widget = {
    ...
    workspaces2: () => WidgetContainer(WorkspacesV2()),
    ...
    keyboard_layout: () => WidgetContainer(KeyboardLayout())
};
...
export const Bar = (() => {
    ...
    return (monitor: number) => {
        ...
        const enabledMonitors = [1, 3];

        return Widget.Window({
            name: `bar-${hyprlandMonitor}`,
            class_name: "bar",
            monitor,
            visible: enabledMonitors.includes(hyprlandMonitor),
